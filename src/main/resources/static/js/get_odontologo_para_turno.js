window.addEventListener('load', function () {
    (function(){
      ...
      //recorremos la colección de odontologos del JSON
         for(odontologo of data){
            ...
            var table = document.getElementById("odontologoTableT");
    ...
    function findOdontologoBy(id){
        ...
        .then(o => {
             ...
             document.querySelector('#nombreO').value = odontologo.nombre;
             document.querySelector('#apellidoO').value = odontologo.apellido;
             document.querySelector('#matriculaO').value = odontologo.matricula;
